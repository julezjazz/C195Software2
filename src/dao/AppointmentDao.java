            ...
            try {
                ...
                while (rs.next()) {
                   ...
                   /* String startDate = startDateTime.toLocalDateTime().toLocalDate().toString();
                    ...
                    LocalDateTime startDateTimeDT = startDateTime.toLocalDateTime();
                    LocalDateTime endDateTimeDT = endDateTime.toLocalDateTime();

                    Appointment newAppointment = new Appointment(appointmentId, title, description, location, type,
                            startDateTimeDT, endDateTimeDT, customerId, userId, contactName);
