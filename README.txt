...
-For the Appointments Report, you can click "Week View" to see appointments in the next 7 days (including the current date) or "Month View" to see appointments in the current month. To delete an appointment from the database, you can click the appointment row, then click "Delete". To modify the appointment in the database, click the row of the appointment you wish to change, then click "Modify Appointment". To add a new appointment tot he database, click "Add Appointment". To return to the Reports Menu, click "Go to Reports Menu". 
